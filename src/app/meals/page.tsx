      ...
      >
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 1 }}>
            ...
            />
            <TextField
              label="CO2-Ersparnis (g)"
              type="number"
              fullWidth
              value={newMeal.co2Savings}
              onChange={(e) =>
                setNewMeal({ ...newMeal, co2Savings: Number(e.target.value) })
              }
            />
          </Stack>
        </DialogContent>
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 1 }}>
            ...
            <TextField
              ...
              onChange={(e) =>
                setEditMeal({ ...editMeal, imageUrl: e.target.value })
              }
            />
            <TextField
              label="Calories"
            ...
            <TextField
              ...
              onChange={(e) =>
                setEditMeal({ ...editMeal, co2Savings: Number(e.target.value) })
              }
            />
          </Stack>
        </DialogContent>
